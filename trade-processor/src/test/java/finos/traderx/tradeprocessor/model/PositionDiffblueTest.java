...
class PositionDiffblueTest {
  ...
  @MethodsUnderTest({"void Position.<init>()", "Integer Position.getAccountId()", "PositionID Position.getPositionID()",
      "Integer Position.getQuantity()", "String Position.getSecurity()", "Date Position.getUpdated()",
      "void Position.setAccountId(Integer)", "void Position.setPositionID(PositionID)",
