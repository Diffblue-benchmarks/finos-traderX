...
class AccountDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return getid is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link Account#Account()}
   */
  @Test
   ...
   * <ul>
   *   <li>When one.
   *   <li>Then return getid intValue is one.
   * </ul>
   *
   * <p>Method under test: {@link Account#Account(Integer, String)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link Account#getid()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link Account#getdisplayName()}
   */
  @Test
