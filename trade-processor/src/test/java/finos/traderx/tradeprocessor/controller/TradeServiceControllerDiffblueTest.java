...
class TradeServiceControllerDiffblueTest {
  ...
  @Autowired private TradeServiceController tradeServiceController;

  /**
   * Test {@link TradeServiceController#processOrder(TradeOrder)}.
   *
   * <p>Method under test: {@link TradeServiceController#processOrder(TradeOrder)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.springframework.http.ResponseEntity TradeServiceController.processOrder(TradeOrder)"
  })
  void testProcessOrder() throws Exception {
    ...
    MockHttpServletRequestBuilder contentTypeResult =
        MockMvcRequestBuilders.post("/tradeservice/order").contentType(MediaType.APPLICATION_JSON);
